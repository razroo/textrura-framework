 ...
 * v1 GEOM binary JSON envelope helpers — {@link encodeBinaryFrameJson} / {@link decodeBinaryFrameJson}
 * (same payload as text frames; parity with `@geometra/server` `binary-frame`).
 */
