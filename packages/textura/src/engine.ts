...
function applyFlexProps(node: Node, props: FlexProps): void {
  ...
  if (props.paddingInlineStart !== undefined)
    node.setPadding(Edge.Start, props.paddingInlineStart)
  if (props.paddingInlineEnd !== undefined)
    node.setPadding(Edge.End, props.paddingInlineEnd)
  if (props.paddingBlockStart !== undefined)
    node.setPadding(Edge.Top, props.paddingBlockStart)
  if (props.paddingBlockEnd !== undefined)
    node.setPadding(Edge.Bottom, props.paddingBlockEnd)
  ...
  if (props.marginInlineStart !== undefined)
    node.setMargin(Edge.Start, props.marginInlineStart)
  if (props.marginInlineEnd !== undefined)
    node.setMargin(Edge.End, props.marginInlineEnd)
  if (props.marginBlockStart !== undefined)
    node.setMargin(Edge.Top, props.marginBlockStart)
  if (props.marginBlockEnd !== undefined)
    node.setMargin(Edge.Bottom, props.marginBlockEnd)
  ...
  if (props.borderInlineStart !== undefined)
    node.setBorder(Edge.Start, props.borderInlineStart)
  if (props.borderInlineEnd !== undefined)
    node.setBorder(Edge.End, props.borderInlineEnd)
  if (props.borderBlockStart !== undefined)
    node.setBorder(Edge.Top, props.borderBlockStart)
  if (props.borderBlockEnd !== undefined)
    node.setBorder(Edge.Bottom, props.borderBlockEnd)
  ...
  if (props.insetInlineStart !== undefined)
    node.setPosition(Edge.Start, props.insetInlineStart)
  if (props.insetInlineEnd !== undefined)
    node.setPosition(Edge.End, props.insetInlineEnd)
  if (props.insetBlockStart !== undefined)
    node.setPosition(Edge.Top, props.insetBlockStart)
  if (props.insetBlockEnd !== undefined)
    node.setPosition(Edge.Bottom, props.insetBlockEnd)
